...
INSERT INTO USER_USED_PK
VALUES(1, 'USER2', 'PASS02', '이순신', '남', '010-5678-9012', 'LEE123@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(KH.USER_NO_PK)에 위배됩니다
--> 기본키 중복으로 오류 


INSERT INTO USER_USED_PK
VALUES(NULL, 'USER2', 'PASS02', '이순신', '남', '010-5678-9012', 'LEE123@kh.or.kr');
...
-- ORA-00001: 무결성 제약 조건(KH.USER_NO_ID_PK)에 위배됩니다
-- 회원 번호와 아이디 둘다 중복되었을 때만 제약조건 위배 에러 발생
...
CREATE TABLE USER_USED_FK(
	...
	GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE /*(GRADE_CODE)*/  -- 컬럼레벨
										-- 컬럼명 미작성 USER_GRADE 테이블의 PK 자동참조
	-- 테이블레벨
...
-- 2) ON DELETE SET NULL : 부모키 삭제시 자식키를 NULL 로 변경하는 옵션
...
-- GENDER 컬럼에 CHECK 제약조건으로 '남' 또는 '여' 만 기록 가능한데, '남자'라는 조건 외 값이 들어와 에러발생
...
CREATE TABLE USER_TEST (
	...
	PNO VARCHAR2(20) CONSTRAINT NN_USER_TEST_PNO NOT NULL,
...
INSERT INTO USER_TEST
VALUES (2, 'user02', 'pass02', '8+0122-2234567', '여', '010-2222-9999', '서울시 강남구 삼성동', 'N');

INSERT INTO USER_TEST
VALUES (3, 'user03', 'pass03', '900122-2234567', '여', '010-3333-9999', '서울시 강남구 대치동', 'Y');

INSERT INTO USER_TEST
VALUES (4, 'user04', 'pass04', '970422-1234567', '남', '010-4444-9999', '서울시 강남구 청담동', 'N');

INSERT INTO USER_TEST
VALUES (5, 'user05', 'pass05', '920522-2234567', '여', '010-5555-9999', '서울시 강남구 도곡동', 'N');

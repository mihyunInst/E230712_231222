...
CREATE USER cmh_sample IDENTIFIED BY 1234;


-- 2. 새 연결(접속방법) 추가
--> CMH_SAMPLE는 CREATE SESSION 권한을 가지고있지 않음; 로그온이 거절되었습니다
--> 접속 권한
...
-- kh / cmh_sample 사용자 계정끼리 서로 객체 접근 권한 부여
...
-- 2. (kh) cmh_sample 계정에 EMPLOYEE 테이블 조회 권한 부여
